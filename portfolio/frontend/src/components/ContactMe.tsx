    ...
    return (
        <div id="projects" className="flex flex-col justify-center h-half gap-32 text-white bg-slate-800" ref={ref}>
            ...
            <div className="flex flex-row justify-evenly">
                <a href="mailto:seokyim8@gmail.com" className="flex flex-col justify-around items-center gap-2 transition duration-300 hover:bg-slate-700  hover:brightness-110 hover:shadow-2xl p-4 rounded-2xl">
